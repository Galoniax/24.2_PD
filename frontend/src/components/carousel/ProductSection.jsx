      ...
      <div className="product-section">
        ...
        <div className="product-info">
          ...
          <h2 className="textRedHatDisplayMedium font-bold text-white">Review</h2>
            ...
            <p className="textNunitoSansLight tracking-tighter leading-7 text-[15px]">"{currentProduct.review}"</p>
          </div>
          ...
          <div className="product-description">
            ...
            <p className="textNunitoSansLight tracking-tighter leading-7 text-[15px]" style={{ textIndent: "30px" }}>{currentProduct.description}</p>
          </div>
        </div>
