...
export function Product() {
  ...
  const getProductSubcategoryName = (subcategoryId) => {
    if (productCategory) {
      const subcategory = productCategory.find(
      ...
      <div className="w-full flex">
        ...
        <div className="w-[60%] flex flex-col justify-center">
          ...
          <button
            ...
            className="bg-[#242424] hover:bg-[#585858] text-white font-semibold py-2 px-4 rounded-3xl mt-10"
          >
                    ...
                    >
                      ...
                      <div className="flex justify-center gap-1">
                        <button
                          ...
                          className="bg-[#2c2c2c] hover:bg-[#585858] w-[75%] mt-5 text-white font-semibold py-1 px-3 rounded-lg"
                        >
                          Ver producto
                        </button>
                        <button
